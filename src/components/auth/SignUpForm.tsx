      ...
      <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <>
            ...
            <div className="pt-4">
              ...
              <div className="flex gap-2">
                <select className="w-full px-3 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-xBlue focus:border-transparent bg-white">
        ...
        {step === 2 && (
          <button
            type="button"
            onClick={() => setStep(1)}
            className="w-full mt-2 border border-gray-300 text-black font-bold py-3 px-4 rounded-full hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-xBlue focus:ring-offset-2"
          >
            Back
          </button>
        )}
